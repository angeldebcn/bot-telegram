...
def mention_html(user_id: int, username: Optional[str] = None,
    ...
    """
    Devuelve una mención HTML clicable que SIEMPRE notifica a la usuaria,
    aunque tenga el grupo silenciado. Usa el enlace tg://user?id= que
    genera una notificación directa.
    """
    if full_name:
        name = full_name
    elif username:
        ...
        name = "usuaria"
    # Escapar caracteres HTML básicos del nombre
